...
namespace margelo::nitro::rnstartiosdk {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rnstartiosdk/Func_void;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rnstartiosdk/Func_void_cxx;";
