...
namespace margelo::nitro::rnstartiosdk {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/rnstartiosdk/Func_void_std__string;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/rnstartiosdk/Func_void_std__string_cxx;";
