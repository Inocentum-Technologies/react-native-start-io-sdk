...
namespace margelo::nitro::rnstartiosdk {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rnstartiosdk/Func_void_std__string;";
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/rnstartiosdk/Func_void_std__string_cxx;";
