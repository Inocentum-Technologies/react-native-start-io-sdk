///
/// HybridRNStartIoNativeAdTouchAreaManager.kt
...
import com.rnstartiosdk.*

/**
 * Represents the React Native `ViewManager` for the "RNStartIoNativeAdTouchArea" Nitro HybridView.
 */
public class HybridRNStartIoNativeAdTouchAreaManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(RNStartIoNativeAdTouchArea::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = RNStartIoNativeAdTouchArea(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridRNStartIoNativeAdTouchAreaStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): RNStartIoNativeAdTouchArea? {
    return view.getTag(associated_hybrid_view_tag) as? RNStartIoNativeAdTouchArea
  }
}
