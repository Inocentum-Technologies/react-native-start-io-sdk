///
/// HybridRNStartIoBannerManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "RNStartIoBanner" Nitro HybridView.
 */
public class HybridRNStartIoBannerManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(RNStartIoBanner::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = RNStartIoBanner(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridRNStartIoBannerStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): RNStartIoBanner? {
    return view.getTag(associated_hybrid_view_tag) as? RNStartIoBanner
  }
}
