///
/// HybridRNStartIoNativeAdManager.kt
...
/**
 * Represents the React Native `ViewManager` for the "RNStartIoNativeAd" Nitro HybridView.
 */
public class HybridRNStartIoNativeAdManager: SimpleViewManager<View>() {
  init {
    if (RecyclableView::class.java.isAssignableFrom(RNStartIoNativeAd::class.java)) {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = RNStartIoNativeAd(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridRNStartIoNativeAdStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): RNStartIoNativeAd? {
    return view.getTag(associated_hybrid_view_tag) as? RNStartIoNativeAd
  }
}
