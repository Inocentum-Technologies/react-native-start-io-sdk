...
public final class Func_void_std__optional_std__string_ {
  ...
  @inline(__always)
  public func call(message: bridge.std__optional_std__string_) -> Void {
    self.closure({ () -> String? in
      if bridge.has_value_std__optional_std__string_(message) {
        let __unwrapped = bridge.get_std__optional_std__string_(message)
